...
(function (G) {
    ...
    api.conn = function (o) {
        ...
        return $.ajax({
            type: 'post',
            url: api.server + '/gap/nodes/' + o.node + '/connection?mac=' + (o.hub || api.hub) + '&chip=' + (o.chip === 1 ? 1 : 0),
            headers: api.local ? '' : {
            ...
            complete: function (jqXHR, text) {
                o.complete && o.complete(o.hub || api.hub, o.node, jqXHR, text)
            },
            error: function (jqXHR, textStatus, errorThrown) {
                o.error && o.error(o.hub || api.hub, o.node, jqXHR, textStatus, errorThrown)
            },
            success: function (data) {
                // debugger
                console.log(data)
